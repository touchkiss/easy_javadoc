# Spec: record-class-params-doc

## Purpose

Define how Easy Javadoc injects `@param` tags into the class-level Javadoc for Java record classes, covering generation, merge behaviour, and isolation from non-record class types.
